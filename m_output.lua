...
__YU_MODULE_LOADER["moai"]=function()
	...
	function __YU_LOADER.CatHead_C1()
		...
		local MOAIGfxQuad2D_C48,new_F1065,new_F556,new_F1753,blockOnAction_F554,MOAIProp2D_C92,MOAIThread_C25 
		local func=function ( self , layer_v3 ) 
			self .prop = new_F1753 ( ) 
			self .quad = new_F1065 ( ) 
	...
	function __YU_LOADER.Main_C2()
		...
		local new_F1033,MOAILayer2D_C64,pushRenderPass_F1817,openWindow_F1830,MOAIViewport_C118,new_F1397,MOAITextBox_C105,MOAIFont_C45,CatHead_C1,new_F1931,MOAISim_C101,new_F2139 
		local func=function ( self ) 
			...
			local font_v9 = new_F1033 ( ) 
			font_v9 :loadFromTTF ( "data/arialbd.ttf" , " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789,.?!" , 12 , 76 ) ; 
			self .textbox = new_F1931 ( ) 
			self .textbox :setFont ( font_v9 ) ; 
			...
			local cathead_v10 = __YU_NEWOBJ( {}, CatHead_C1 ) 
			cathead_v10 :init ( self .layer ) ; 
		 end ; 
